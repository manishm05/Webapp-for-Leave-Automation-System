...
<html lang="en">
  <head>
    ...
    <title>Employee Area | View Rejected Request</title>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
			...
			<li class="active"><a href="http://localhost/registration/employee_rejected_request.php">Rejected</a></li>
                ...
                <div class="col-md-13">
                  ...
                  <?php
				   ...
				   $myname_1=$_COOKIE["name"];
					$sql="select type_of_leave, concerned_manager,time_of_leave, date, reason from apply_leave where user_id='$myid_1' and status='rejected'";
