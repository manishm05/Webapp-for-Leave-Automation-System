...
if(!empty($myid_1))
{
if(!empty($_POST['id']) and !empty($_POST['username']) and !empty($_POST['position_1'])and !empty($_POST['password_1']) and !empty($_POST['password_2']))
{
   $myuserid=$_POST['id'];
   $myusername=$_POST['username'];
   $my_position=$_POST['position_1'];
   $mypassword=$_POST['password_1'];
   $confirmpassword=$_POST['password_2'];
   $count=0;
   $sql1="Select position from user";
   $retval1= mysqli_query($conn, $sql1);
   while($user= mysqli_fetch_assoc($retval1))
   {
	   $count++;
   }
   if($count>=1 and $my_position=='admin')
   {
	   echo"There cannot be two admins.";
   }
   else if(true)
   {
   if($mypassword == $confirmpassword)
   {
      ...
      "(user_id,user_name, position,password,confirm_password)".
      "VALUES( '$myuserid', '$myusername', '$my_position', '$mypassword', '$confirmpassword')";  
...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Register User</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="http://localhost/registration/register.php">Add</a></li>
    ...
    <header id="header">
      <div class="container">
          <div class="row">
            <div class="col-md-10">
                <h1><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Dashboard<small>Add</small></h1>
            </div>
          </div>
      </div>
    </header>
      ...
      <div class="container">
		...
		<form action="" method="POST">
			...
			<div class="input-group">
				...
				<select value="position" name="position_1">
