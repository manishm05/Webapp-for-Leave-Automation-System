<?php
	...
	$sql1="update apply_leave set status='approved' where status='rejected' and concerned_manager='".$_COOKIE['name']."' and leave_id=".$_GET['approve'];
	$result1=mysqli_query($conn, $sql1);
	header("location:Officer_rejected_request.php");
	}
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Officer/Scientist Area | View Rejected Request</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
			...
			<li class="active"><a href="http://localhost/registration/officer_rejected_request.php">Rejected</a></li>
    ...
    <header id="header">
      <div class="container">
          <div class="row">
            <div class="col-md-10">
                <h1><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Dashboard<small>Rejected</small></h1>
            </div>
	...
	$sql = "Select leave_id, user_id, user_name, type_of_leave,date from apply_leave where status='rejected' and concerned_manager= '$myname_1'";
			...
			while($user=mysqli_fetch_assoc($record))
	{
		...
		echo "<td>"."<a href=Officer_rejected_request.php?approve=".$user['leave_id']." class=btn name=approve >APPROVE</a> "."</td>";
		echo "</tr>";
	}
	?>
		</table>      
