      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="http://localhost/registration/employee.php">Dashboard</a></li>
              ...
              <div class="panel-body">
                <div class="col-md-3">
                  <div class="well dash-box">
                    ...
                    <button class="button"><h4><a href="http://localhost/registration/apply_for_leave.php">Apply For Short Leave</a></h4></button>
                  </div>
                </div>
				<div class="col-md-3">
                  <div class="well dash-box">
                    <h3><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></h3>
                    <button class="button"><h4><a href="http://localhost/registration/employee_full_leave.php">Apply For Full Leave</a></h4></button>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h3><span class="glyphicon glyphicon-th" aria-hidden="true"></span></h3>
					<button class="button"><h4><a href="http://localhost/registration/employee_view_all.php">View All Leaves</a></h4></button>
                  </div>
                </div>
              </div>
            </div>
