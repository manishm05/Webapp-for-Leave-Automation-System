	...
	if(!empty($_POST['reason']))
{
   ...
   $timeofleave=$_POST['leave_time'];
   $mydate= $_POST['date'];
   $mydate1= $mydate;
   $reason_1=$_POST['reason'];
   $now= strtotime($mydate1);
   ...
   $sql = "INSERT INTO apply_leave".
     ...
     "VALUES($abcx, '$myuserid','short leave', '$myusername' ,'$typeofleave', '$concernedmanager', '$timeofleave', '$mydate','$mydate1','$count', '$reason_1','Pending')";  
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="http://localhost/registration/apply_for_leave.php">Short Leave</a></li>
    ...
    <header id="header">
      <div class="container">
          <div class="row">
            <div class="col-md-10">
                <h1><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Dashboard<small>Short Leave</small></h1>
            </div>
          </div>
      </div>
    </header>
    <section id="breadcrumb">
      <div class="container">
        <ol class="breadcrumb">
		  ...
		  <li class="active">Apply For Short Leave</li>
        </ol>
      </div>
    </section>
    <section id="main" >
...
<?php
			...
			$result5=mysqli_query($conn, $sql5);
			$abcdefg= count(mysqli_query($conn, $sql5));
			while($user=mysqli_fetch_row($result5))
			{
				$abc= $user[0];
			}
	...
	while($row = mysqli_fetch_array($result))
	{
	 ...
	 ?>
					...
					<div class="radio-inline" >
						<input type="radio" name="leave_time" value="before break"/>Before Break<br>
						<input type="radio" name="leave_time" value="after break"/>After Break
					</div>
